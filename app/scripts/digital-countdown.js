(function(window, $, undefined) {
    ...
    $.fn.countdownDigital = function(options){
        ...
        function drawCountdown(element) {
            ...
            var num, numSplit, numSplitWithCommas, isComma, isColon, digit;
            ...
            $.each(_labels, function(labelKey, labelVal){
                ...
                $.each(numSplitWithCommas, function(numberKey, numberVal){
                    ...
                    // isComma = undefined === _digits[val] ? true : false;
                ...
                if(_defaults._labels) label.append('<span class="text">'+labelVal+'</span>');
        ...
        return this.each(function(){
            ...
            _mSecsRefreshDisplay = true === _defaults.showMSecs ? 100000 : 1000;
        ...
        function addCommas(numbers) {
            ...
            // arr_length = true === _defaults.showMSecs ? arr_length - 4 : arr_length;
